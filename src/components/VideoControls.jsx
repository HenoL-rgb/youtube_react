  ...
  return (
    <div className={classes.container}>
        <div className={classes.time}>
            ...
            <input type={'range'} value={playedSeconds} style={getBackgroundSize(playedSeconds, duration)} max={duration} min='0' step='1' onChange={(e) => handleProgress(e.target.value)}/>
        </div>
